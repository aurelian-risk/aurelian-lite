...
export const DEFAULT_TAXONOMY: Taxonomy = {
  ...
  groups: [
    ...
    { key: "ws4", label: "Operational Scenarios", description: "Kill-chains with MITRE ATT&CK® tactics", color: "var(--color-workshop-4)" },
  ...
  entityTypes: [
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "reliability", label: "Reliability", type: "scale", scaleLabels: RELIABILITY },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "likelihood", label: "Likelihood", type: "scale", scaleLabels: LIKELIHOOD },
        { key: "difficulty", label: "Difficulty", type: "scale", scaleLabels: ["trivial", "low", "moderate", "high"] },
      ],
    },
    {
      ...
      fields: [
        ...
        { key: "tactic", label: "ATT&CK® Tactic", type: "enum", options: TACTICS },
        { key: "technique", label: "Technique (id / name)", type: "text", help: "e.g. T1566 Phishing (MITRE ATT&CK® technique)." },
    ...
    },
    {
      ...
      fields: [
        ...
        { key: "resistance_strength", label: "Resistance strength", type: "scale", scaleLabels: RQ5 },
