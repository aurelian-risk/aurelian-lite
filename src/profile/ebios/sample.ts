...
export function makeSampleStudy(): Study {
  ...
  add("security_measure", { name: "Egress monitoring & DLP", description: "Egress monitoring and data-loss-prevention rules detect and block bulk transfers of health records to external destinations, whether staged over a web service before ransomware or copied to removable media by an insider.", scope: "in use", measure_type: "Detective", status: "Planned", priority: 3, implementation_level: 2, covers: [stExfil, stI3], protects: [saHis] });
  add("security_measure", { name: "EDR on clinical endpoints", description: "Endpoint detection and response on clinical endpoints and servers flags the tell-tale behaviour of credential dumping, suspicious scheduled tasks and mass file encryption, giving the SOC a chance to contain the intrusion before impact.", scope: "in use", measure_type: "Detective", status: "Implemented", priority: 3, implementation_level: 3, covers: [st2, st3, st6, stI2], protects: [saHis], fulfills: [reqIncident] });
  add("security_measure", { name: "Offline immutable backups", description: "Air-gapped, immutable backups of the patient database with regular restore drills, so that even if the Hospital Information System is encrypted the hospital can recover within hours rather than paying a ransom.", scope: "in use", measure_type: "Corrective", status: "Implemented", priority: 4, implementation_level: 4, covers: [st6], protects: [saBackup], fulfills: [reqBackup, reqData] });
